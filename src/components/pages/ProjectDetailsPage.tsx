  ...
  return (
    <main className="project-detail case-study">
      ...
      <section className="case-section case-overview">
        ...
        <ScrollReveal className="case-two-column case-overview-content">
      ...
      <section className="case-section">
        ...
        <ScrollReveal className="case-two-column case-problem-columns">
      ...
      <section className="case-section case-solution">
        ...
        <ScrollReveal delay={0.08} className="integration-panel">
      ...
      <section className="case-section" id="architecture">
        ...
        <ScrollReveal className="case-two-column architecture-intro">
      ...
      <section className="case-section">
        ...
        <ScrollReveal className="case-two-column decision-columns">
      ...
      <section className="case-section">
        ...
        <ScrollReveal className="error-type-list">{cs.errorTypes.map((type) => <code key={type}>{type}</code>)}</ScrollReveal>
        <ScrollReveal delay={0.06} className="reliability-grid">{cs.reliability.map(([title, copy]) => <article data-spotlight key={title}><h3>{title}</h3><p>{copy}</p></article>)}</ScrollReveal>
      ...
      <section className="case-section">
        ...
        <ScrollReveal delay={0.08} className="capability-grid">{cs.capabilities.map((item) => <span key={item}>{item}</span>)}</ScrollReveal>
      </section>
